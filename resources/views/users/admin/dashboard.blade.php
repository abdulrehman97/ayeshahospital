        ...
        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <h3 class="kt-subheader__title">Ayesha Maternity Center And Hospital</h3>

                    <span class="kt-subheader__separator kt-subheader__separator--v"></span>

                    <span class="kt-subheader__desc">KHADRA, LUCKNOW</span>
                        ...
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                   Welcome to Ayesha Maternity Center And Hospital
                                </h3>
                            </div>
                        </div>
                            ...
                            <div class="kt-portlet__body">
                                <div class="form-group form-group-last">
                                    <div class="alert alert-secondary" role="alert">
                                        <div class="alert-icon"><i class="fas fa-hospital"></i></div>
                                        <div class="alert-text">
                                            For You For Your Family For Life
                                        </div>
                                    </div>
                                     <div class="card bg-dark text-white">
  <img class="card-img" src="https://image.shutterstock.com/shutterstock/photos/588196298/display_1500/stock-vector-medical-concept-with-hospital-building-and-doctor-in-flat-style-panoramic-background-with-hospital-588196298.jpg" alt="Card image">
