                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="first_name" class="form-control" type="text" name="first_name"
                                               value="{{isset($doctor) ? $doctor->first_name : ''}}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-heading"></i></span></div>
                                        <input id="last_name" class="form-control required" type="text" name="last_name"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="email" class="form-control" type="text" name="email"
                                               value="{{isset($doctor) ? $doctor->email : ''}}" required>
                                    </div>
                                </div>
                                @if(!isset($doctor))
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="phone" class="form-control" type="number" name="phone"
                                               value="{{isset($doctor) ? $doctor->phone : ''}}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="mobile" class="form-control" type="number" name="mobile"
                                               value="{{isset($doctor) ? $doctor->mobile : ''}}" required>
                                    </div>
                                </div>
                                <div class="form-group">
